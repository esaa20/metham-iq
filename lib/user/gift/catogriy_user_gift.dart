...
import 'package:metham/user/gift/user_gift.dart';



class catogriyUserGift extends StatelessWidget {
  catogriyUserGift({
    required this.agent,
                    ...
                    child: Stack(
                      children: [
                        ...
                        Container(
                          ...
                          child: InkWell(
                            onTap: (){
                               Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => UserGift(catogryName: catoryDocs[index].id, agent: agent, userScore: userScore, docid: docid, name: name,),));
                            },
                            borderRadius: BorderRadius.circular(20),
                            child: Container(
                              child: Center(
