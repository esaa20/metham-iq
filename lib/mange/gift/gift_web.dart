...
class ImageUploadGift extends StatefulWidget {
  @override
  _ImageUploadGiftState createState() => _ImageUploadGiftState();
}

class _ImageUploadGiftState extends State<ImageUploadGift> {
  html.File? _imageFile;
  String? _imageUrl;
  TextEditingController kindGift = TextEditingController();
  TextEditingController giftName = TextEditingController();
  TextEditingController giftScore = TextEditingController();
  ...
  Future<void> _uploadData() async {
    if (_imageFile != null &&
        kindGift.text.isNotEmpty &&
        giftName.text.isNotEmpty &&
        giftScore.text.isNotEmpty) {
      ...
      // };
      await FirebaseFirestore.instance.collection('gift').doc(kindGift.text).collection(kindGift.text).doc(giftName.text).set({
        'kindGift':kindGift.text,
        'giftName':giftName.text,
        'giftScore':giftScore.text,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('قسم الهدايا',style: TextStyle(fontFamily: 'Cairo',),),
