...
class ImageUploadOffer extends StatefulWidget {
  @override
  _ImageUploadOfferState createState() => _ImageUploadOfferState();
}

class _ImageUploadOfferState extends State<ImageUploadOffer> {
  html.File? _imageFile;
  String? _imageUrl;
  TextEditingController _offerName = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('صور الاعلانات',style: TextStyle(fontFamily: 'Cairo',),),
