...
class ImageUploadCatogriyItem extends StatefulWidget {
  @override
  _ImageUploadCatogriyItemState createState() => _ImageUploadCatogriyItemState();
}

class _ImageUploadCatogriyItemState extends State<ImageUploadCatogriyItem> {
  ...
  Future<void> _uploadData() async {
    if (_imageFile != null &&
      ...
      // };
      await FirebaseFirestore.instance.collection('items').doc(caName.text).set({
        'id':1,
        'image':downloadUrl
      });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('صور الاصناف',style: TextStyle(fontFamily: 'Cairo',),),
